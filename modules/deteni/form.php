...
if ($_GET['form'] == 'add') { ?>
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=deteni"> Deteni </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST" action="modules/deteni/proses.php?act=insert" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="blok" autocomplete="off" required>
                </div>
              </div>
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="?module=deteni" class="btn btn-default btn-reset">Batal</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
...
elseif ($_GET['form'] == 'edit') {
  if (isset($_GET['id'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM deteni WHERE id_deteni='$_GET[id]'")
...
?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Ubah Data Deteni
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=beranda"><i class="fa fa-home"></i> Beranda</a></li>
      <li><a href="?module=deteni"> Deteni </a></li>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST" action="modules/deteni/proses.php?act=update" enctype="multipart/form-data">
            <div class="box-body">

              <input type="hidden" name="id_deteni" value="<?php echo $data['id_deteni']; ?>">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Blok</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="blok" autocomplete="off" value="<?php echo $data['blok']; ?>" required>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Catatan</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="catatan" autocomplete="off" value="<?php echo $data['catatan']; ?>" required>
                </div>
              </div>
