...
$query = mysqli_query($mysqli, "SELECT kode_deteni,nama_deteni,blok_deteni,asal FROM is_deteni ORDER BY nama_deteni ASC")
...
<body>
    ...
    <div>
        <table style="width:100%;" border="0">
            <tr>
                <td>
                    <div id="title3">LAPORAN DATA DETENI</div>
                </td>
            </tr>
        </table>
    </div>
        ...
        <table width="100%" border="0.3" cellpadding="0" cellspacing="0" align="center">
            <thead style="background:#e8ecee">
                <tr class="tr-title">
                    ...
                    <th height="20" align="center" valign="middle">BLOK</th>
                    <th height="20" align="center" valign="middle">ASAL PENGIRIMAN</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                while ($data = mysqli_fetch_assoc($query)) {
                    ...
                    echo "  <tr>
                        ...
                        <td style='padding-left:5px;' width='180' height='13' valign='middle'>$data[nama_deteni]</td>
                        <td style='padding-right:10px;' width='80' height='13' align='center' valign='middle'>$data[blok_deteni]</td>
                        <td style='padding-right:10px;' width='200' height='13'  valign='middle'>$data[asal]</td>
                    </tr>";
                    $no++;
                }
                ?>
...
<?php
$filename = "LAPORAN DATA DETENI.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
